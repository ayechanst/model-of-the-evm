...
* Wallets => Robot Butlers
** Seed phrase 
When whispered in the butler's ear, the butler can unlock any accounts owned by the owner.
** Private key management
In their abdoment/chest compartment, the butler holds the private keys to the owner's trains stations. 
** Butler behavior
*** Signing transactions
The butler can go to different train stations, and use a private key in their chest to open the locked door. Then the butler can sign a trainsaction with the correct private key and send the train where it needs to go. 
*** Viewing balances
The butler can view the balance in the train station and report how much is there. 
